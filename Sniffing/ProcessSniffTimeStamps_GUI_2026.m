function varargout = ProcessSniffTimeStamps_GUI_2026(varargin)
% PROCESSSNIFFTIMESTAMPS_GUI_2026 MATLAB code for ProcessSniffTimeStamps_GUI_2026.fig
%      PROCESSSNIFFTIMESTAMPS_GUI_2026, by itself, creates a new PROCESSSNIFFTIMESTAMPS_GUI_2026 or raises the existing
%      singleton*.
%
%      H = PROCESSSNIFFTIMESTAMPS_GUI_2026 returns the handle to a new PROCESSSNIFFTIMESTAMPS_GUI_2026 or the handle to
%      the existing singleton*.
%
%      PROCESSSNIFFTIMESTAMPS_GUI_2026('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in PROCESSSNIFFTIMESTAMPS_GUI_2026.M with the given input arguments.
%
%      PROCESSSNIFFTIMESTAMPS_GUI_2026('Property','Value',...) creates a new PROCESSSNIFFTIMESTAMPS_GUI_2026 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before ProcessSniffTimeStamps_GUI_2026_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to ProcessSniffTimeStamps_GUI_2026_OpeningFcn via varargin.
%
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @ProcessSniffTimeStamps_GUI_2026_OpeningFcn, ...
                   'gui_OutputFcn',  @ProcessSniffTimeStamps_GUI_2026_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before ProcessSniffTimeStamps_GUI_2026 is made visible.
function ProcessSniffTimeStamps_GUI_2026_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to ProcessSniffTimeStamps_GUI_2026 (see VARARGIN)

% Choose default command line output for ProcessSniffTimeStamps_GUI_2026
...
function varargout = ProcessSniffTimeStamps_GUI_2026_OutputFcn(hObject, eventdata, handles) 
...
switch handles.datamode
    ...
    case 'onlyEphys'
        load(handles.WhereSession.String, 'AllSniffs', 'RespirationData','KS4Units'); % AllSniffs: nx13, RespirationData: t x 3(ts, raw, filt, MFS)
...
% --- Executes on button press in ShowSpikeRaster.
function ShowSpikeRaster_Callback(hObject, eventdata, handles)
% hObject    handle to ShowSpikeRaster (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of ShowSpikeRaster
