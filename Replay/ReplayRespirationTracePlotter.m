function [] = ReplayRespirationTracePlotter(TemplateTraces, ActiveReplayTraces, PassiveReplayTraces)
...
for i = 1:n(1)
    ...
    plot(TemplateTraces.Timestamps{1}(10:end,i) - ...
        ...
        TemplateTraces.Sniffs{1}(10:end,i), 'color', Plot_Colors('k'));
...
for i = 1:n(2)
    ...
    plot(ActiveReplayTraces.Timestamps{1}(10:end,i) - ...
        ...
        ActiveReplayTraces.Sniffs{1}(10:end,i), 'color', Plot_Colors('t'));
    set(gca,'XTick',[]);
end
...
for i = 1:n(3)
    ...
    plot(PassiveReplayTraces.Timestamps{i} - ...
        ...
        PassiveReplayTraces.Sniffs{i}, 'color', Plot_Colors('r'));
    set(gca,'XTick',[]);
end
end