function [kernelsout,resnorm,residual,exitflag,output] = GetSniffKernels_v2(StartingKernels, SniffParams, SniffPSTHs, varargin)
...
% hack: 
StartingKernels = [StartingKernels(1) randi(10,1,5*5) StartingKernels(end)];
...
function [zdata] = sniff_out(StartingKernels,xdata)
    ...
    [baseline,kernels,locationcoef] = ParseGaborSniffKernels(Starting_Kernels);
    % get psth
